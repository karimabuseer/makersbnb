...
class Listing
  ...
  def self.create(name:, description:, price:)
    result = database_connection.exec("INSERT INTO listings (name, description, price) VALUES('#{name.gsub("'", "''")}', '#{description.gsub("'", "''")}', '#{price}') RETURNING listing_id, name, description, price;")
